...
Public Class transaksi_pembayaran
    ...
    Private Sub transaksi_pembayaran_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        connect()
        aturdgv()
    End Sub
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        connect()
        If txtidbayar.Text = "" Or txtidptgs.Text = "" Or txtnisn.Text = "" Or txtthnbayar.Text = "" Or txtblnbayar.Text = "" And txtidspp.Text = "" Then
            MsgBox("Pastikan mengisi semua field dengan benar")
        Else
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        If txtidbayar.Text = "" Or txtidptgs.Text = "" Or txtnisn.Text = "" Or txtthnbayar.Text = "" Or txtblnbayar.Text = "" Or txtidspp.Text = "" Then
            MsgBox("Pastikan mengisi semua field dengan benar")
        Else
            sql = "Delete pembayaran where id_pembayaran = '" & txtidbayar.Text & "'"
            cmd = New SqlCommand(sql, con)
            cmd.ExecuteNonQuery()
